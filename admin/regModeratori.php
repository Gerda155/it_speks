...
<main>
    <div class="login-container">
        <div class="login-box">
            <h1>Izveidot jaunu moderatoru</h1>
            ...
            <form action="" method="POST">
                ...
                <select name="statuss" id="statuss" required>
                    <option value="Aktivs" selected>Aktīvs</option>
                    <option value="Neaktivs">Neaktīvs</option>
                </select>

                <button type="submit" id="izveidot"><i class="fas fa-plus-circle"></i> Izveidot moderatoru</button>
            </form>
